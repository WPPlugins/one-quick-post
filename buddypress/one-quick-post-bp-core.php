...
function oqp_bp_setup_globals() {
	...
	$bp->oqp->slug = OQP_SLUG;
	$bp->oqp->format_notification_function = 'oqp_bp_format_notifications';
...
function oqp_bp_setup_root_component() {

	/* Register 'OQP' as a root component */
	bp_core_add_root_component( OQP_SLUG );
}
